  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center py-12">
        ...
        <span className="mr-4 text-gray-600 font-medium">در حال دریافت تایم‌ها...</span>
      </div>
    );
  }
  ...
  if (!slots.length) {
    return (
      <div className="text-center py-12 bg-gray-50 rounded-2xl border-2 border-dashed border-gray-200">
        ...
        <p className="text-gray-600 font-medium">تایمی برای این روز وجود ندارد</p>
        <p className="text-gray-400 text-sm mt-1">لطفاً روز دیگری انتخاب کنید</p>
      </div>
    );
  }
      ...
      {slots.map((slot) => {
        ...
        return (
          <button
            ...
            `}
          >
            {/* Background gradient for available slots */}
            {!isReserved && (
